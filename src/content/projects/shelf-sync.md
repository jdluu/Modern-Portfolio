...
summary: "Syncs Calibre ebook libraries between devices over the local network. No cloud, no cables, metadata intact."
role: "Developer"
...
reflection: "This was my proper introduction to Rust and Tauri: async task management, and bridging systems-level backend code with a web UI. It also confirmed my preference for local-first tools — faster, private, and no subscription."
links:
  live: ""
