/**
 * CommonJS version of the ts-morph cleanup script.
 * Removes unused named/default imports from TypeScript files in src/.
 *
 * Run with: node ./scripts/cleanup-unused-imports.cjs
 */
